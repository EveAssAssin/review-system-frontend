        ...
        <div className="border-t pt-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-xs px-3 py-1.5 text-white rounded disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            >
              ...
              {analysisBusy ? 'AI 分析中（10-30 秒）...' : record.employee_analysis ? '重新分析' : '執行 AI 分析'}
            </button>
          </div>

          {analysisBusy && (
            <div className="mb-2 bg-purple-50 border border-purple-200 rounded p-2 text-xs text-purple-700">
              正在讀取員工歷次評價並送 AI 分析，這需要 10-30 秒，請稍候不要關閉頁面...
            </div>
          )}
